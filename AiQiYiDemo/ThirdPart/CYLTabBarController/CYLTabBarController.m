...
-(void)viewWillAppear:(BOOL)animated
{
 ...
 if ([widow.rootViewController isKindOfClass:[UINavigationController class]])
  {
  UINavigationController *nav = (UINavigationController *)widow.rootViewController;
...
- (CYLTabBarController *)cyl_tabBarController {
 ...
 {
  UINavigationController *nav = (UINavigationController *)tabBarController;
 for (UIViewController *vc in nav.viewControllers)
 {
 if ([vc isKindOfClass:[CYLTabBarController class]])
  {
   tabBarController = (CYLTabBarController *)vc;
 }
 }
 }
    return tabBarController;
